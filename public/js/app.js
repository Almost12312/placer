...
var loginBtn = document.getElementById('auth__submit');
if (loginBtn) {
...
var _loop = function _loop(i) {
  redBtn[i].addEventListener('click', function () {
    ...
    var title = document.querySelectorAll('.ad__title')[i].textContent;
    var content = document.querySelectorAll('.ad__content')[i].textContent;
    var location = document.querySelectorAll('.ad__location')[i].textContent;
    var price = document.querySelectorAll('.ad__price')[i].textContent;
    var image = document.querySelectorAll('.adv_img')[i].src;
    console.log(image);
    ...
    var priceRed = document.querySelector('.price__red').value = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.toInteger)(price);
...
document.querySelector('.upload__img').addEventListener('change', function (files) {
  var imgContainer = document.querySelector('.images__preview');
